...
export const codeGraveAccent = 0x0060 // `
export const codeLowercaseA = 0x61 // "a"
export const codeLowercaseE = 0x65 // "e"
export const codeLowercaseF = 0x66 // "f"
export const codeLowercaseJ = 0x6a // "j"
export const codeLowercaseN = 0x6e // "n"
export const codeLowercaseO = 0x6f // "o"
export const codeLowercaseS = 0x73 // "s"
