...
function outputHelp () {
  ...
  console.log()
  console.log('Repair invalid JSON documents. When a document could not be repaired, the output will be left unchanged.')
  console.log()
  console.log('Usage:')
  ...
  console.log('    jsonrepair broken.json                        # Repair a file, output to console')
  console.log('    jsonrepair broken.json > repaired.json        # Repair a file, output to file')
  console.log('    jsonrepair broken.json --overwrite            # Repair a file, replace the file itself')
  console.log('    cat broken.json | jsonrepair                  # Repair data from an input stream')
  console.log('    cat broken.json | jsonrepair > repaired.json  # Repair data from an input stream, output to file')
  console.log()
}
...
function streamToString (readableStream) {
  return new Promise((resolve, reject) => {
    ...
    readableStream.on('data', chunk => { text += String(chunk) })
